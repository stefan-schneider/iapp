...
describe "User pages" do
  ...
  describe "signup" do
    ...
    describe "with valid information" do
      before do
        fill_in "Name",         with: "Beng Beng Steve"
        fill_in "Email",        with: "bengbengsteve@gmail.com"
        fill_in "Password",     with: "aberdeen"
        fill_in "Confirm Password", with: "aberdeen"
      end
      ...
      describe "after saving the user" do
        before { click_button submit }
        let(:user) { User.find_by(email: 'bengbengsteve@gmail.com') }
  ...
  describe "edit" do
    ...
    before do
      sign_in user # to be signed in in order to test sign-out link
