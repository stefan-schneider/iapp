...
(function() {
  ...
  $(document).ready(function() {
    return $('#textBox').keyup(updateCount);
  });

  updateCount = function() {
    var green, orange, red, rem;
    red = "red";
    orange = "orange";
    green = "green";
    rem = 160 - $('#textBox').val().length;
    $('#remaining').removeClass("red");
    $('#remaining').removeClass("orange");
    $('#remaining').removeClass("green");
    if (rem < 1) {
      $('#remaining').innerHTML()("" + rem + " letter left");
      $('#remaining').addClass(red);
    }
    if (rem < 20) {
      $('#remaining').innerHTML()("" + rem + " letters left");
      return $('#remaining').addClass(orange);
    } else {
      $('#remaining').innerHTML()("" + rem + " letters left");
      return $('#remaining').addClass(green);
    }
  };
